...
<head>
  ...
  <link rel="stylesheet" href="../Vista/css/Seguimiento_Profesor_ModificarProfesor.css">
</head>
<body>
 <!-- Menú lateral -------------------------------------------------------------------------------------------->
<nav>
...
<!------------------------------------------------------------------------------------------------------------------------------->
  ...
  <h2>Modificar Información del Profesor</h2>

  <form class="formulario-profesor" action="#" method="POST">
    <input type="hidden" name="id_profesor" value="1"> <!-- ID oculto -->
    ...
    <input type="email" id="correo" name="correo" value="juan.perez@colegio.edu" required>

    <label for="telefono">Teléfono:</label>
    <input type="tel" id="telefono" name="telefono" value="7788-9900" required>

    <label for="direccion">Dirección:</label>
    <textarea id="direccion" name="direccion" rows="3" required>Colonia El Centro, San Salvador</textarea>
